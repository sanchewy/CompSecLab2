...
public class CompSecLab2 {
    ...
    public static void readFile(String[] hashValues) {
        ...
        File file = new File(".\\src\\compseclab2\\rockyou.txt");
        FileReader fr = null;
        try{
        ...
        try{
            while((line = br.readLine()) != null) {
                ...
                double elapsed = (double)(t2-time)/(1000000000.0);
                String cipherText = md5(line);
                for(String val : hashValues) {if(cipherText.equals(val)){ System.out.println("Password: "+line+" Hash value: "+cipherText+" Elapsed time: "+elapsed+" sec."); }};
            }
        } catch (IOException e) {
            Logger.getLogger(CompSecLab2.class.getName()).log(Level.SEVERE, null, e);
        }
